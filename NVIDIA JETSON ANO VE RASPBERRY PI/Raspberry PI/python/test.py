#                   MICRO PYTHON   RASPBERRY PI STEP MOTOR DRV8825 TEST murat ırkan
import RPi.GPIO as GPIO
import time
from DRV8825 import DRV8825_STEP_MOTOR_SURUCU

try:
    Motor1 = DRV8825_STEP_MOTOR_SURUCU(dir_pin=13, step_pin=19, enable_pin=12, mode_pins=(16, 17, 20))
    Motor2 = DRV8825_STEP_MOTOR_SURUCU(dir_pin=24, step_pin=18, enable_pin=4, mode_pins=(21, 22, 27))
