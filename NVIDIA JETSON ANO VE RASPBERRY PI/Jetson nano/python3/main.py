#                  MICRO PYTHON  NVIDIA JETSON NANO drv8825 step motor
...
try:
    ...
    Motor1.mikro_adım_ayarla('softward','fullstep')
    Motor1.TurnStep(Dir='ileri', steps=200, stepdelay = 0.005)
    time.sleep(0.5)
    Motor1.TurnStep(Dir='geri', steps=400, stepdelay = 0.005)
    Motor1.Stop()
