...
class DRV8825():
    ...
    def sayısal_yaz(self, pin, value):
        GPIO.output(pin, value)
        
    def durdur(self):
        self.digital_write(self.enable_pin, 1)
    
    def mikro_adım_ayarla(self, mode, stepformat):
        """
        (1) mode
        ...
        print ("kontrol modu:",mode)
        if (mode == ControlMode[1]):
            print ("pinleri ayarla")
            self.sayısal_yaz.mode_pins,microstep[stepformat]
